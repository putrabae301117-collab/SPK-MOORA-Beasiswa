    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800 mt-1">{{ $periode->alternatifs->count() }}</p>
                        </div>
                ...
                @php
                    $jumlahAlternatif = $periode->alternatifs->count();
                    $jumlahDinilai = $periode->penilaians->count();
                    $jumlahBelum = $jumlahAlternatif - $jumlahDinilai;
                @endphp
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-500 font-medium">Sudah Dinilai</p>
                            <p class="text-2xl font-bold text-gray-800 mt-1">{{ $jumlahDinilai }}</p>
                        </div>
